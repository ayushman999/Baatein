    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ReactionPopup popup = new ReactionPopup(context, config, (pos) -> {
            if(holder.getClass().equals(SentViewHolder.class))
            {
                ...
                viewHolder.binding.sentEmotion.setImageResource(reactions[pos]);
                viewHolder.binding.sentEmotion.setVisibility(View.VISIBLE);
            }
            else if(holder.getClass().equals(ReceiverViewHolder.class)){
                ReceiverViewHolder receiverViewHolder=(ReceiverViewHolder) holder;
                receiverViewHolder.binding.imageView4.setImageResource(reactions[pos]);
                receiverViewHolder.binding.imageView4.setVisibility(View.VISIBLE);
            }
        ...
        if(holder.getClass().equals(SentViewHolder.class))
        {
            ...
            {
                viewHolder.binding.sentEmotion.setImageResource(reactions[message.getFeeling()]);
                viewHolder.binding.sentEmotion.setVisibility(View.VISIBLE);
            }
            else
            {
                viewHolder.binding.sentEmotion.setVisibility(View.INVISIBLE);
            }
        ...
        else
        {
            ...
            if(message.getFeeling()>=0)
            {
                viewHolder.binding.imageView4.setImageResource(reactions[message.getFeeling()]);
                viewHolder.binding.imageView4.setVisibility(View.VISIBLE);
            }
            else
            {
                viewHolder.binding.imageView4.setVisibility(View.INVISIBLE);
